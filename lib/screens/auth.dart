...
class _AuthorizationPage extends State<AuthorizationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget _input(Icon icon, String hint, TextEditingController controller, bool isObscure) {
      return Container(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        child:
                            Text('Not registered yet? Register!', style: TextStyle(fontSize: 20, color: Colors.white)),
                        onTap: () {
                          setState(() {
                            showLogin = false;
                          });
              ...
              : Column(
                  children: <Widget>[
                    ...
                    Padding(
                      padding: EdgeInsets.all(10),
                      child: GestureDetector(
                        child: Text('Already Registed?', style: TextStyle(fontSize: 20, color: Colors.white)),
                        onTap: () {
                          setState(() {
                            showLogin = true;
                          });
